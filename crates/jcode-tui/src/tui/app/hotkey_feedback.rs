...
pub(super) struct RegistryInputs<'a> {
    ...
    pub model_picker_toggle: &'a OptionalBinding,
...
pub(super) fn build_registry(inputs: &RegistryInputs<'_>) -> Vec<KnownHotkey> {
    ...
    push(
        inputs.model_picker_toggle.binding.clone(),
        "model_picker_toggle",
...
impl App {
    ...
    fn hotkey_registry(&self, remote: bool) -> Vec<KnownHotkey> {
        build_registry(&RegistryInputs {
            ...
            model_picker_toggle: &self.model_picker_toggle_key,
...
mod tests {
    ...
    fn test_inputs_registry(remote: bool) -> Vec<KnownHotkey> {
        ...
        let model_picker_toggle = OptionalBinding {
            binding: Some(alt('p')),
            label: Some("Alt+P".to_string()),
        };
        ...
        build_registry(&RegistryInputs {
            ...
            model_picker_toggle: &model_picker_toggle,
    ...
    fn registry_covers_every_canonical_keybinding_default() {
        ...
        let mapping: &[(&str, Option<&[&str]>)] = &[
            ...
            ("model_picker_toggle", Some(&["model_picker_toggle"])),
        ];
